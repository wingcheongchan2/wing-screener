...
# 讀取本地圖片並轉換為 Base64 的函數 (防止讀取失敗導致崩潰)
...
with st.sidebar:
    st.markdown("### 🦅 ALPHA STATION <span style='font-size:10px; color:#E53935; border:1px solid #E53935; padding:1px 3px;'>V18.1 Stable</span>", unsafe_allow_html=True)
